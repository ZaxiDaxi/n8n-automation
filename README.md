...
This repo contains **4 n8n workflows** that connect **Gmail ✉️, Telegram 💬, LLMs 🧠, and Google Sheets 📊** to:
- triage emails ✅
- draft replies ✍️
- manage edits 🛠️
...
### 1) ⏱️ Edit Session V1 (`Edit Session V1.json`)
- Runs **every minute** ⏳
...
### 2) ✉️➡️💬 Email to Telegram V1 (`Email to Telegram V1.json`)
- Triggered by **Gmail polling every minute** ⏱️
- Fetches full email 📩
- If attachments exist (PDF/image), summarizes them via OpenAI 🧠🗂️
- Builds cleaned email context 🧹
- Classifies email into: `IGNORE` 🚫, `FYI` ℹ️, or `ACTION NEEDED` ⚠️
- Sends results to Telegram 💬
- If `ACTION NEEDED`:
  - drafts a reply with LLM ✍️🧠
  - creates a Gmail draft 📨
  - posts inline buttons: **Approve ✅ / Edit ✏️ / History 🕘 / Style 🎨**
...
- Summarizes attachments 🗂️ and classifies emails 🧠
...
### 4) 💬➡️✉️ Telegram to Email V1 (`Telegram to Email V1.json`)
- Handles Telegram messages + callback buttons 🔘 (**Approve ✅ / Edit ✏️ / History 🕘 / Style 🎨**)
- Supports **voice edits** 🎙️:
  - download voice 📥
  - convert to WAV 🎧
  - transcribe with Deepgram 📝
- Creates + validates **5-minute edit sessions** ⏳✅
- Applies edit instructions via LLM 🧠✍️
